...
#include "prototype_msg/action/detail/movefeedback__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const prototype_msg::action::Movefeedback_Goal & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  prototype_msg::action::Movefeedback_Goal & ros_message)
{
  // Member: linear_x
  cdr >> ros_message.linear_x;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = prototype_msg::action::Movefeedback_Goal;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const prototype_msg::action::Movefeedback_Goal *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<prototype_msg::action::Movefeedback_Goal *>(
    untyped_ros_message);
...
{
  return &prototype_msg::action::typesupport_fastrtps_cpp::_Movefeedback_Goal__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, prototype_msg, action, Movefeedback_Goal)() {
  return &prototype_msg::action::typesupport_fastrtps_cpp::_Movefeedback_Goal__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_prototype_msg
cdr_serialize(
  const prototype_msg::action::Movefeedback_Result & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: pos_x
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  prototype_msg::action::Movefeedback_Result & ros_message)
{
  // Member: pos_x
  cdr >> ros_message.pos_x;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = prototype_msg::action::Movefeedback_Result;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const prototype_msg::action::Movefeedback_Result *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<prototype_msg::action::Movefeedback_Result *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &prototype_msg::action::typesupport_fastrtps_cpp::_Movefeedback_Result__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, prototype_msg, action, Movefeedback_Result)() {
  return &prototype_msg::action::typesupport_fastrtps_cpp::_Movefeedback_Result__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_prototype_msg
cdr_serialize(
  const prototype_msg::action::Movefeedback_Feedback & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: error_s
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  prototype_msg::action::Movefeedback_Feedback & ros_message)
{
  // Member: error_s
  cdr >> ros_message.error_s;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = prototype_msg::action::Movefeedback_Feedback;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const prototype_msg::action::Movefeedback_Feedback *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<prototype_msg::action::Movefeedback_Feedback *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &prototype_msg::action::typesupport_fastrtps_cpp::_Movefeedback_Feedback__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, prototype_msg, action, Movefeedback_Feedback)() {
  return &prototype_msg::action::typesupport_fastrtps_cpp::_Movefeedback_Feedback__handle;
}
...
// functions for prototype_msg::action::Movefeedback_Goal already declared above
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_prototype_msg
cdr_serialize(
  const prototype_msg::action::Movefeedback_SendGoal_Request & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: goal_id
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  prototype_msg::action::Movefeedback_SendGoal_Request & ros_message)
{
  // Member: goal_id
  ...
  size_t current_alignment)
{
  ...
  // Member: goal
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        prototype_msg::action::typesupport_fastrtps_cpp::max_serialized_size_Movefeedback_Goal(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = prototype_msg::action::Movefeedback_SendGoal_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const prototype_msg::action::Movefeedback_SendGoal_Request *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<prototype_msg::action::Movefeedback_SendGoal_Request *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &prototype_msg::action::typesupport_fastrtps_cpp::_Movefeedback_SendGoal_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, prototype_msg, action, Movefeedback_SendGoal_Request)() {
  return &prototype_msg::action::typesupport_fastrtps_cpp::_Movefeedback_SendGoal_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_prototype_msg
cdr_serialize(
  const prototype_msg::action::Movefeedback_SendGoal_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: accepted
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  prototype_msg::action::Movefeedback_SendGoal_Response & ros_message)
{
  // Member: accepted
  {
    uint8_t tmp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = prototype_msg::action::Movefeedback_SendGoal_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const prototype_msg::action::Movefeedback_SendGoal_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<prototype_msg::action::Movefeedback_SendGoal_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &prototype_msg::action::typesupport_fastrtps_cpp::_Movefeedback_SendGoal_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, prototype_msg, action, Movefeedback_SendGoal_Response)() {
  return &prototype_msg::action::typesupport_fastrtps_cpp::_Movefeedback_SendGoal_Response__handle;
}
...
{
  return &prototype_msg::action::typesupport_fastrtps_cpp::_Movefeedback_SendGoal__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, prototype_msg, action, Movefeedback_SendGoal)() {
  return &prototype_msg::action::typesupport_fastrtps_cpp::_Movefeedback_SendGoal__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_prototype_msg
cdr_serialize(
  const prototype_msg::action::Movefeedback_GetResult_Request & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: goal_id
  unique_identifier_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  prototype_msg::action::Movefeedback_GetResult_Request & ros_message)
{
  // Member: goal_id
  unique_identifier_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
    cdr, ros_message.goal_id);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = prototype_msg::action::Movefeedback_GetResult_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const prototype_msg::action::Movefeedback_GetResult_Request *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<prototype_msg::action::Movefeedback_GetResult_Request *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &prototype_msg::action::typesupport_fastrtps_cpp::_Movefeedback_GetResult_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, prototype_msg, action, Movefeedback_GetResult_Request)() {
  return &prototype_msg::action::typesupport_fastrtps_cpp::_Movefeedback_GetResult_Request__handle;
}
...
// forward declaration of message dependencies and their conversion functions
// functions for prototype_msg::action::Movefeedback_Result already declared above
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_prototype_msg
cdr_serialize(
  const prototype_msg::action::Movefeedback_GetResult_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: status
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  prototype_msg::action::Movefeedback_GetResult_Response & ros_message)
{
  // Member: status
  cdr >> ros_message.status;
  ...
  size_t current_alignment)
{
  ...
  // Member: result
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        prototype_msg::action::typesupport_fastrtps_cpp::max_serialized_size_Movefeedback_Result(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = prototype_msg::action::Movefeedback_GetResult_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const prototype_msg::action::Movefeedback_GetResult_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<prototype_msg::action::Movefeedback_GetResult_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &prototype_msg::action::typesupport_fastrtps_cpp::_Movefeedback_GetResult_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, prototype_msg, action, Movefeedback_GetResult_Response)() {
  return &prototype_msg::action::typesupport_fastrtps_cpp::_Movefeedback_GetResult_Response__handle;
}
...
{
  return &prototype_msg::action::typesupport_fastrtps_cpp::_Movefeedback_GetResult__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, prototype_msg, action, Movefeedback_GetResult)() {
  return &prototype_msg::action::typesupport_fastrtps_cpp::_Movefeedback_GetResult__handle;
}
...
// functions for prototype_msg::action::Movefeedback_Feedback already declared above
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_prototype_msg
cdr_serialize(
  const prototype_msg::action::Movefeedback_FeedbackMessage & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: goal_id
  unique_identifier_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  prototype_msg::action::Movefeedback_FeedbackMessage & ros_message)
{
  // Member: goal_id
  unique_identifier_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
    cdr, ros_message.goal_id);
  ...
  size_t current_alignment)
{
  ...
  // Member: feedback
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        prototype_msg::action::typesupport_fastrtps_cpp::max_serialized_size_Movefeedback_Feedback(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = prototype_msg::action::Movefeedback_FeedbackMessage;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const prototype_msg::action::Movefeedback_FeedbackMessage *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<prototype_msg::action::Movefeedback_FeedbackMessage *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &prototype_msg::action::typesupport_fastrtps_cpp::_Movefeedback_FeedbackMessage__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, prototype_msg, action, Movefeedback_FeedbackMessage)() {
  return &prototype_msg::action::typesupport_fastrtps_cpp::_Movefeedback_FeedbackMessage__handle;
}
