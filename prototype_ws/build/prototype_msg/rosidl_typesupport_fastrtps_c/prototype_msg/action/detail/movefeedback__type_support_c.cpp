...
#include "prototype_msg/action/detail/movefeedback__rosidl_typesupport_fastrtps_c.h"
...
using _Movefeedback_Goal__ros_msg_type = prototype_msg__action__Movefeedback_Goal;
...
size_t get_serialized_size_prototype_msg__action__Movefeedback_Goal(
  const void * untyped_ros_message,
...
static uint32_t _Movefeedback_Goal__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_prototype_msg__action__Movefeedback_Goal(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_prototype_msg
size_t max_serialized_size_prototype_msg__action__Movefeedback_Goal(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = prototype_msg__action__Movefeedback_Goal;
    is_plain =
      (
...
static size_t _Movefeedback_Goal__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_prototype_msg__action__Movefeedback_Goal(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, prototype_msg, action, Movefeedback_Goal)() {
...
using _Movefeedback_Result__ros_msg_type = prototype_msg__action__Movefeedback_Result;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_prototype_msg
size_t get_serialized_size_prototype_msg__action__Movefeedback_Result(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Movefeedback_Result__ros_msg_type * ros_message = static_cast<const _Movefeedback_Result__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_prototype_msg__action__Movefeedback_Result(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_prototype_msg
size_t max_serialized_size_prototype_msg__action__Movefeedback_Result(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = prototype_msg__action__Movefeedback_Result;
    is_plain =
      (
      offsetof(DataType, pos_y) +
      last_member_size
      ) == ret_val;
  }
...
static size_t _Movefeedback_Result__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_prototype_msg__action__Movefeedback_Result(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, prototype_msg, action, Movefeedback_Result)() {
...
using _Movefeedback_Feedback__ros_msg_type = prototype_msg__action__Movefeedback_Feedback;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: error_s
  {
    cdr << ros_message->error_s;
  }

  // Field name: error_theta
  {
    cdr << ros_message->error_theta;
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_prototype_msg
size_t get_serialized_size_prototype_msg__action__Movefeedback_Feedback(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Movefeedback_Feedback__ros_msg_type * ros_message = static_cast<const _Movefeedback_Feedback__ros_msg_type *>(untyped_ros_message);
  ...
  // field.name error_s
  {
    size_t item_size = sizeof(ros_message->error_s);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // field.name error_theta
  {
    size_t item_size = sizeof(ros_message->error_theta);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
...
{
  return static_cast<uint32_t>(
    get_serialized_size_prototype_msg__action__Movefeedback_Feedback(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_prototype_msg
size_t max_serialized_size_prototype_msg__action__Movefeedback_Feedback(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = prototype_msg__action__Movefeedback_Feedback;
    is_plain =
      (
      offsetof(DataType, error_theta) +
      last_member_size
      ) == ret_val;
  }
...
static size_t _Movefeedback_Feedback__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_prototype_msg__action__Movefeedback_Feedback(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, prototype_msg, action, Movefeedback_Feedback)() {
...
// already included above
// #include "prototype_msg/action/detail/movefeedback__functions.h"  // goal
...
using _Movefeedback_SendGoal_Request__ros_msg_type = prototype_msg__action__Movefeedback_SendGoal_Request;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: goal
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, prototype_msg, action, Movefeedback_Goal
      )()->data);
    if (!callbacks->cdr_serialize(
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_prototype_msg
size_t get_serialized_size_prototype_msg__action__Movefeedback_SendGoal_Request(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Movefeedback_SendGoal_Request__ros_msg_type * ros_message = static_cast<const _Movefeedback_SendGoal_Request__ros_msg_type *>(untyped_ros_message);
  ...
  current_alignment += get_serialized_size_prototype_msg__action__Movefeedback_Goal(
...
{
  return static_cast<uint32_t>(
    get_serialized_size_prototype_msg__action__Movefeedback_SendGoal_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_prototype_msg
size_t max_serialized_size_prototype_msg__action__Movefeedback_SendGoal_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: goal
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_prototype_msg__action__Movefeedback_Goal(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = prototype_msg__action__Movefeedback_SendGoal_Request;
    is_plain =
      (
...
static size_t _Movefeedback_SendGoal_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_prototype_msg__action__Movefeedback_SendGoal_Request(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, prototype_msg, action, Movefeedback_SendGoal_Request)() {
...
using _Movefeedback_SendGoal_Response__ros_msg_type = prototype_msg__action__Movefeedback_SendGoal_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_prototype_msg
size_t get_serialized_size_prototype_msg__action__Movefeedback_SendGoal_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Movefeedback_SendGoal_Response__ros_msg_type * ros_message = static_cast<const _Movefeedback_SendGoal_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_prototype_msg__action__Movefeedback_SendGoal_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_prototype_msg
size_t max_serialized_size_prototype_msg__action__Movefeedback_SendGoal_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = prototype_msg__action__Movefeedback_SendGoal_Response;
    is_plain =
      (
...
static size_t _Movefeedback_SendGoal_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_prototype_msg__action__Movefeedback_SendGoal_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, prototype_msg, action, Movefeedback_SendGoal_Response)() {
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, prototype_msg, action, Movefeedback_SendGoal)() {
...
using _Movefeedback_GetResult_Request__ros_msg_type = prototype_msg__action__Movefeedback_GetResult_Request;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_prototype_msg
size_t get_serialized_size_prototype_msg__action__Movefeedback_GetResult_Request(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Movefeedback_GetResult_Request__ros_msg_type * ros_message = static_cast<const _Movefeedback_GetResult_Request__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_prototype_msg__action__Movefeedback_GetResult_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_prototype_msg
size_t max_serialized_size_prototype_msg__action__Movefeedback_GetResult_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = prototype_msg__action__Movefeedback_GetResult_Request;
    is_plain =
      (
...
static size_t _Movefeedback_GetResult_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_prototype_msg__action__Movefeedback_GetResult_Request(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, prototype_msg, action, Movefeedback_GetResult_Request)() {
...
// already included above
// #include "prototype_msg/action/detail/movefeedback__functions.h"  // result
...
using _Movefeedback_GetResult_Response__ros_msg_type = prototype_msg__action__Movefeedback_GetResult_Response;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: result
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, prototype_msg, action, Movefeedback_Result
      )()->data);
    if (!callbacks->cdr_serialize(
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_prototype_msg
size_t get_serialized_size_prototype_msg__action__Movefeedback_GetResult_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Movefeedback_GetResult_Response__ros_msg_type * ros_message = static_cast<const _Movefeedback_GetResult_Response__ros_msg_type *>(untyped_ros_message);
  ...
  current_alignment += get_serialized_size_prototype_msg__action__Movefeedback_Result(
...
{
  return static_cast<uint32_t>(
    get_serialized_size_prototype_msg__action__Movefeedback_GetResult_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_prototype_msg
size_t max_serialized_size_prototype_msg__action__Movefeedback_GetResult_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: result
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_prototype_msg__action__Movefeedback_Result(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = prototype_msg__action__Movefeedback_GetResult_Response;
    is_plain =
      (
...
static size_t _Movefeedback_GetResult_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_prototype_msg__action__Movefeedback_GetResult_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, prototype_msg, action, Movefeedback_GetResult_Response)() {
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, prototype_msg, action, Movefeedback_GetResult)() {
...
// already included above
// #include "prototype_msg/action/detail/movefeedback__functions.h"  // feedback
// already included above
// #include "unique_identifier_msgs/msg/detail/uuid__functions.h"  // goal_id
...
using _Movefeedback_FeedbackMessage__ros_msg_type = prototype_msg__action__Movefeedback_FeedbackMessage;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: feedback
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, prototype_msg, action, Movefeedback_Feedback
      )()->data);
    if (!callbacks->cdr_serialize(
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_prototype_msg
size_t get_serialized_size_prototype_msg__action__Movefeedback_FeedbackMessage(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Movefeedback_FeedbackMessage__ros_msg_type * ros_message = static_cast<const _Movefeedback_FeedbackMessage__ros_msg_type *>(untyped_ros_message);
  ...
  current_alignment += get_serialized_size_prototype_msg__action__Movefeedback_Feedback(
...
{
  return static_cast<uint32_t>(
    get_serialized_size_prototype_msg__action__Movefeedback_FeedbackMessage(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_prototype_msg
size_t max_serialized_size_prototype_msg__action__Movefeedback_FeedbackMessage(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: feedback
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_prototype_msg__action__Movefeedback_Feedback(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = prototype_msg__action__Movefeedback_FeedbackMessage;
    is_plain =
      (
...
static size_t _Movefeedback_FeedbackMessage__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_prototype_msg__action__Movefeedback_FeedbackMessage(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, prototype_msg, action, Movefeedback_FeedbackMessage)() {
